  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        ...
        <CardContent>
          <Table>
            <TableHeader><TableRow><TableHead>Servicio</TableHead><TableHead>Cliente</TableHead><TableHead>Fecha Finalizado</TableHead><TableHead className="text-right">Tu Ganancia</TableHead><TableHead className="text-right">Comisión</TableHead><TableHead>Estado Comisión</TableHead></TableRow></TableHeader>
            <TableBody>
              {completedRequests && completedRequests.length > 0 ? (
                ...
                <TableRow><TableCell colSpan={6} className="text-center h-24">No tienes servicios completados todavía.</TableCell></TableRow>
              )}
            </TableBody>
          </Table>
        </CardContent>
